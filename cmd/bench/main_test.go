...
func render() {
	...
	m, err := gogl.NewModelFromFile("/home/fleg/projects/gogl/assets/african_head.obj")
	// m, err := gogl.NewModelFromFile("./assets/teapot.obj")
	if err != nil {
		panic(err)
	}

	// texture, err := CanvasFromPNG("/home/fleg/projects/gogl/assets/african_head_diffuse.png")
	// if err != nil {
	// 	panic(err)
	// }
	texture := gogl.NewCanvas(1024, 1024)
	...
	// CanvasToPNG(canvas, "/home/fleg/projects/gogl/model.png")
}
